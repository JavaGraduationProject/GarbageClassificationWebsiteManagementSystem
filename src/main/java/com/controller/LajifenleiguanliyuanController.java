 ...
 */
@RestController
@RequestMapping("/lajifenleiguanliyuan")
public class LajifenleiguanliyuanController {
    @Autowired
    private LajifenleiguanliyuanService lajifenleiguanliyuanService;
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		LajifenleiguanliyuanEntity user = lajifenleiguanliyuanService.selectOne(new EntityWrapper<LajifenleiguanliyuanEntity>().eq("guanliyuanzhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		
		String token = tokenService.generateToken(user.getId(), username,"lajifenleiguanliyuan",  "垃圾分类管理员" );
    ...
    public R register(@RequestBody LajifenleiguanliyuanEntity lajifenleiguanliyuan){
		...
		lajifenleiguanliyuan.setId(uId);
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        LajifenleiguanliyuanEntity user = lajifenleiguanliyuanService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        user.setMima("123456");
        lajifenleiguanliyuanService.updateById(user);
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,LajifenleiguanliyuanEntity lajifenleiguanliyuan, HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("lajifenleiguanliyuan")) {
			lajifenleiguanliyuan.setGuanliyuanzhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/add")
    public R add(@RequestBody LajifenleiguanliyuanEntity lajifenleiguanliyuan, HttpServletRequest request){
    	lajifenleiguanliyuan.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(lajifenleiguanliyuan);
    	LajifenleiguanliyuanEntity user = lajifenleiguanliyuanService.selectOne(new EntityWrapper<LajifenleiguanliyuanEntity>().eq("guanliyuanzhanghao", lajifenleiguanliyuan.getGuanliyuanzhanghao()));
		if(user!=null) {
    ...
    public R update(@RequestBody LajifenleiguanliyuanEntity lajifenleiguanliyuan, HttpServletRequest request){
        //ValidatorUtils.validateEntity(lajifenleiguanliyuan);
        lajifenleiguanliyuanService.updateById(lajifenleiguanliyuan);//全部更新
        return R.ok();
    }
    ...
    public R delete(@RequestBody Long[] ids){
        lajifenleiguanliyuanService.deleteBatchIds(Arrays.asList(ids));
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<LajifenleiguanliyuanEntity> wrapper = new EntityWrapper<LajifenleiguanliyuanEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = lajifenleiguanliyuanService.selectCount(wrapper);
