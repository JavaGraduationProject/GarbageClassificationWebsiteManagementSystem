  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 1);borderRadius:10px">
        <h1 class="h1" style="color:rgba(131, 138, 182, 1);fontSize:28px;">垃圾分类网站注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.dizhi" autocomplete="off" placeholder="地址" type="text" />
																								...
																								<!-- <div v-if="tableName=='lajifenleiguanliyuan'" class="input-group">
			   <div class="label">管理员账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.guanliyuanzhanghao" class="input" type="text" placeholder="管理员账号">
			   </div>
			 </div> -->
			<el-form-item label="管理员账号" class="input" v-if="tableName=='lajifenleiguanliyuan'">
			  <el-input v-model="ruleForm.guanliyuanzhanghao" autocomplete="off" placeholder="管理员账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='lajifenleiguanliyuan'" class="input-group">
			...
			<el-form-item label="管理员姓名" class="input" v-if="tableName=='lajifenleiguanliyuan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='lajifenleiguanliyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='lajifenleiguanliyuan'" class="input-group">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='lajifenleiguanliyuan'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='lajifenleiguanliyuan'">
			...
			<el-form-item label="电子邮箱" class="input" v-if="tableName=='lajifenleiguanliyuan'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                  ...
                                                                                                                  if((!this.ruleForm.guanliyuanzhanghao) && `lajifenleiguanliyuan` == this.tableName){
        this.$message.error(`管理员账号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.guanliyuanxingming) && `lajifenleiguanliyuan` == this.tableName){
        this.$message.error(`管理员姓名不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `lajifenleiguanliyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                              if(`lajifenleiguanliyuan` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
        this.$message.error(`年龄应输入整数`);
        return
      }
                                                                                    if(`lajifenleiguanliyuan` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
        this.$message.error(`联系电话应输入手机格式`);
        return
      }
                                                                        if(`lajifenleiguanliyuan` == this.tableName && this.ruleForm.dianziyouxiang&&(!this.$validate.isEmail(this.ruleForm.dianziyouxiang))){
